...
if sayfa == "📝 Eylül Ayı Rezervasyon Formu":
    ...
    with st.form("aylik_rezervasyon_formu", clear_on_submit=True):
    ...
    if submit_btn:
        ...
        if not (sicil.strip() and ad_soyad.strip() and mudurluk.strip() and unvan.strip()):
            ...
            if not kural_ihlali:
                ...
                st.session_state.basari_mesaji = f"✅ Sayın **{ad_soyad}**, Eylül ayı için toplam **{len(yeni_kayitlar)} günlük** rezervasyon kaydınız başarıyla tamamlandı!"
